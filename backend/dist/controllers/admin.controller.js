...
// GET /api/admin/stats
export const getSystemStats = async (_req, res, next) => {
    try {
...
export const getSafetyEvents = async (req, res, next) => {
    try {
...
export const resolveEvent = async (req, res, next) => {
    try {
        const { id } = req.params;
...
export const getUsers = async (req, res, next) => {
    try {
        ...
        const result = await query(`SELECT id, name, email, created_at, crisis_count, is_admin 
             FROM users 
