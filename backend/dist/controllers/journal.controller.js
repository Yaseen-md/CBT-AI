...
import { createMemory, getMemoriesByUser, getMemoryById, updateMemory, deleteMemory, } from '../services/memory.service.js';
/**
 * POST /api/journal
 ...
 */
export const getRecentDistortions = async (req, res, next) => {
    try {
        const userId = req.user.id;
