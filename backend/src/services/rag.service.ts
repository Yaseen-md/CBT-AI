import { cognitiveDistortions, KnowledgeEntry } from '../data/knowledge-base/distortions';
...
export class RagService {
     ...
     */
    static getRelevantContext(userInput: string, limit: number = 2): KnowledgeEntry[] {
        if (!userInput) return [];
